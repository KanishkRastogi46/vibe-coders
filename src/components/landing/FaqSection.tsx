        ...
        <div className="max-w-[800px] mx-auto">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="border-purple-800/30">
              <AccordionTrigger className="text-white">How does the image-to-code feature work?</AccordionTrigger>
            ...
            <AccordionItem value="item-2" className="border-purple-800/30">
              <AccordionTrigger className="text-white">Is AutoDev suitable for beginners?</AccordionTrigger>
              <AccordionContent className="text-gray-300">
            ...
            <AccordionItem value="item-3" className="border-purple-800/30">
              <AccordionTrigger className="text-white">What programming languages are supported?</AccordionTrigger>
              <AccordionContent className="text-gray-300">
            ...
            <AccordionItem value="item-5" className="border-purple-800/30">
              <AccordionTrigger className="text-white">Is there a free plan available?</AccordionTrigger>
              <AccordionContent className="text-gray-300">
            ...
            <AccordionItem value="item-6" className="border-purple-800/30">
              <AccordionTrigger className="text-white">How secure is my code on AutoDev?</AccordionTrigger>
              <AccordionContent className="text-gray-300">
